...
<main>
  <div class="main-links">
    ...
    <a href="#/explore" class:active={$location === "/explore"}>
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 510 510" style="enable-background:new 0 0 510 510;" xml:space="preserve">
        <g>
          <g id="explore">
            <path
  ...
  <a href="#/settings" class:active={$location === "/settings"}>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" id="Layer_1" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve" width="24px" height="24px">
      <g>
        <g>
          <path
...
<style lang="scss">
  ...
  .active {
    ...
    box-shadow: 0px 4px 40px 10px #5c5c5cab;
    svg {
      fill: white;
    }
  }
